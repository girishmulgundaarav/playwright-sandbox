          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-8 shadow-xs flex flex-col justify-between">
            <div>
              ...
              <div className="rounded-xl bg-slate-50 border border-slate-200 p-6 space-y-4">
                <div>
                  <label className="block text-xs font-semibold text-slate-605 uppercase tracking-wider mb-2">Select Country</label>
                  <select
                  ...
                  >
                    ...
                    <option value="US" data-testid="standard-option-US">United States</option>
                    <option value="CA" data-testid="standard-option-CA">Canada</option>
                    <option value="UK" data-testid="standard-option-UK">United Kingdom</option>
                    <option value="AU" data-testid="standard-option-AU">Australia</option>
                  </select>
                </div>

                {selectedCountry && (
                  <div className="text-xs text-slate-500">
                    Selected code: <span className="font-mono font-bold text-indigo-650">{selectedCountry}</span>
                  </div>
                )}
              </div>
            </div>
